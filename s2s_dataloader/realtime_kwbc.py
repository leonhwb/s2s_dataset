...
class KWBC_Realtime(S2SRealtimeBase):

    def __init__(self):
        S2SRealtimeBase.__init__(self, data_center='kwbc')
...
if __name__ == "__main__":
    ...
    # data = obj.load(parameter_level='tp', init_date='20210701')
    # obj.post_process(data, parameter='tp')
