...
class Download_BABJ_Reforecast(ReforecastGrib_OnTheFly_Download):
    """
    下载babj的近实时预报数据，扰动模式
    """
    ...
    def __init__(self, number):
        ReforecastGrib_OnTheFly_Download.__init__(self, number=number, data_center='babj')
...
class _Test:
    def test1(self):
        n = 2
        obj = Download_BABJ_Reforecast(n)
        # obj.retrieve_2t_wtmp('2t', '20210701', f'2t_{n}.grib')
        # obj.retrieve_2t_wtmp('wtmp', '20210701', f'wtmp_{n}.grib')
        # obj.retrieve_10u10v('10u', '2021-07-01', f'10u_{n}.grib')
        # obj.retrieve_10u10v('10v', '2021-07-01', f'10v_{n}.grib')
        # obj.retrieve_mx2t6_mn2t6_tp('tp', '2021-07-01', f'tp_{n}.grib')
        # obj.retrieve_mx2t6_mn2t6_tp('mx2t6', '2021-07-01', f'mx2t6_{n}.grib')
        # obj.retrieve_mx2t6_mn2t6_tp('mn2t6', '2021-07-01', f'mn2t6_{n}.grib')
