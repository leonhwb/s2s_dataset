...
class Download_KWBC_PF_Realtime(RealTimeGribDownload):
    """
    下载kwbc的近实时预报数据，扰动模式
    """
    ...
    def __init__(self, number):
        RealTimeGribDownload.__init__(self,  number=number, data_center='kwbc')
...
class _Test:
    def test1(self):
        obj = Download_KWBC_PF_Realtime(number=1)
