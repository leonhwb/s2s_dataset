...
from .main import ReforecastGrib_OnTheFly_Download

server = ECMWFDataServer()


class Download_ECMF_Reforecast(ReforecastGrib_OnTheFly_Download):
    """
    下载ecmf的回算数据，只下载控制模式cf
    """
    ...
    def __init__(self, number):
        ReforecastGrib_OnTheFly_Download.__init__(self, number=number, data_center='ecmf')
    ...
    def retrieve_2t_wtmp(self, parameter, init_date: str, save_path: str):
        ...
        server.retrieve({
            ...
            "date": init_date,
            "expver": "prod",
            "hdate": self.hindcast_dates(init_date),
            "levtype": "sfc",
            "model": "glob",
    ...
    def retrieve_10u10v_tp(self, parameter: str, init_date: str, save_path: str):
        assert parameter in ['10u', '10v', 'tp']
        server.retrieve({
            "number": str(self.number),
            "class": "s2",
            "dataset": "s2s",
    ...
    def retrieve_single_level(self, parameter: str, init_date: str, save_path: str):
        ...
        elif parameter in ('10u', '10v', 'tp'):
            self.retrieve_10u10v_tp(**kwarg)
...
class _Test:
    def test1(self):
        n = 2
        obj = Download_ECMF_Reforecast(n)
        obj.retrieve_2t_wtmp('2t', '20210701', f'2t_{n}.grib')
        obj.retrieve_2t_wtmp('wtmp', '20210701', f'wtmp_{n}.grib')
        obj.retrieve_10u10v_tp('10u', '2021-07-01', f'10u_{n}.grib')
        obj.retrieve_10u10v_tp('10v', '2021-07-01', f'10v_{n}.grib')
        obj.retrieve_10u10v_tp('tp', '2021-07-01', f'tp_{n}.grib')
        obj.retrieve_mx2t6_mn2t6('mx2t6', '2021-07-01', f'mx2t6_{n}.grib')
        obj.retrieve_mx2t6_mn2t6('mn2t6', '2021-07-01', f'mn2t6_{n}.grib')
        obj.retrieve_sp_msl('sp', '2021-07-01', f'sp_{n}.grib')
        obj.retrieve_sp_msl('msl', '2021-07-01', f'msl_{n}.grib')
        for p in obj.pressure_level.keys():
            obj.retrieve_pressure_level(p, 850, '2021-07-01', f'{p}850_{n}.grib')
        ...
        for f in [f for f in os.listdir(dir) if f.endswith('grib')]:
            ...
            print(f.split('.')[0], data.name, data.shape, data.number.values)
