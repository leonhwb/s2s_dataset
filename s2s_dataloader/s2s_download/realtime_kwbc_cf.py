...
class Download_KWBC_CF_Realtime(RealTimeGribDownload):
    """
    下载kwbc的近实时预报数据，只下载控制模式cf
    """
    ...
    def __init__(self):
        RealTimeGribDownload.__init__(self, number=0, data_center='kwbc')
    ...
    def retrieve_2t_wtmp(self, parameter, init_date: str, save_path: str):
        ...
        server.retrieve({
            ...
            "step": "24-48/48-72/72-96/96-120/120-144/144-168/168-192/192-216/216-240/240-264/264-288/288-312/312-336"
                    "/336-360/360-384/384-408/408-432/432-456/456-480/480-504/504-528/528-552/552-576/576-600/600-624"
                    "/624-648/648-672/672-696/696-720/720-744/744-768/768-792/792-816/816-840/840-864/864-888/888-912"
                    "/912-936/936-960/960-984/984-1008/1008-1032/1032-1056",
            "stream": "enfo",
            "time": "00:00:00",
            "type": self.data_type,
            "target": save_path,
    ...
    def retrieve_10u10v_sp(self, parameter: str, init_date: str, save_path: str):
        assert parameter in ('10u', '10v', 'sp')
        server.retrieve({
            "class": "s2",
            "dataset": "s2s",
            "date": init_date,
            ...
            "origin": self.data_center,
            "param": self.parameter_num[parameter],
            "step": "24/48/72/96/120/144/168/192/216/240/264/288/312/336/360/384/408/432/456/480/504/528/552/576/600"
                    "/624/648/672/696/720/744/768/792/816/840/864/888/912/936/960/984/1008/1032/1056",
            "stream": "enfo",
            "time": "00:00:00",
            "type": self.data_type,
            "target": save_path,
    ...
    def retrieve_msl(self, init_date: str, save_path: str):
        parameter = 'msl'
        server.retrieve({
            "class": "s2",
            "dataset": "s2s",
            ...
            "step": "0/24/48/72/96/120/144/168/192/216/240/264/288/312/336/360/384/408/432/456/480/504/528/552/576"
                    "/600/624/648/672/696/720/744/768/792/816/840/864/888/912/936/960/984/1008/1032/1056",
            "stream": "enfo",
            "time": "00:00:00",
            "type": self.data_type,
            "target": save_path,
    ...
    def retrieve_single_level(self, parameter: str, init_date: str, save_path: str):
        ...
        if parameter in ('2t', 'wtmp'):
            ...
            self.retrieve_10u10v_sp(**kwarg)
        elif parameter in ('mx2t6', 'mn2t6', 'tp'):
            self.retrieve_mx2t6_mn2t6_tp(**kwarg)
        elif parameter == 'msl':
            self.retrieve_msl(init_date=init_date, save_path=save_path)
        return True


class _Test:
    def test1(self):
        obj = Download_KWBC_CF_Realtime()
        obj.retrieve_2t_wtmp('2t', '2021-07-01', '2t.grib')
        obj.retrieve_2t_wtmp('wtmp', '2021-07-01', 'wtmp.grib')
        obj.retrieve_10u10v_sp('10u', '2021-07-01', '10u.grib')
        obj.retrieve_10u10v_sp('10v', '2021-07-01', '10v.grib')
        obj.retrieve_10u10v_sp('sp', '2021-07-01', 'sp.grib')
        ...
        obj.retrieve_msl('2021-07-01', 'msl.grib')
        ...
        for f in [f for f in os.listdir(dir) if f.endswith('grib')]:
            ...
            print(f.split('.')[0], data.name,  data.shape)
