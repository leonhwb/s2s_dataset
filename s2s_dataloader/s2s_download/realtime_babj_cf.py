...
class Download_BABJ_CF_Realtime(RealTimeGribDownload):
    """
    下载babj的近实时预报数据，只下载控制模式cf
    """
    ...
    def __init__(self):
        RealTimeGribDownload.__init__(self, number=0, data_center='babj')
